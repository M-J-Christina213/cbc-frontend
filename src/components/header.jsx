      ...
      <header className="bg-white w-full shadow-md">
        ...
        <nav className="bg-black hidden lg:flex justify-center py-3 shadow-sm">
          <ul className="flex space-x-8 font-semibold text-white">
                ...
                <Menu.Items className="absolute left-0 mt-2 bg-white shadow-md rounded-md w-40 text-sm group-hover:block hidden">
                  <Menu.Item>
                    {({ active }) => (
                      <Link
                        to="/skincare"
                        className={`block px-4 py-2 text-black ${active ? "border-b-2 border-secondary" : ""}`}
                      >
                        Skincare
                      </Link>
                    )}
            ...
            <li>
              <Link to="/special-offers" className="hover:border-b-2 border-secondary pb-1">
                Special Offers
              </Link>
            </li>
            <li>
              <Link to="/gifts" className="hover:border-b-2 border-secondary pb-1">
                Gifts
              </Link>
            </li>
            <li>
              <Link to="/about-us" className="hover:border-b-2 border-secondary pb-1">
                About Us
              </Link>
            </li>
            <li>
              <Link to="/contact-us" className="hover:border-b-2 border-secondary pb-1">
                Contact Us
              </Link>
            </li>
          </ul>
