...
const reviews = [
  ...
  { id: 9, name: "Dinusha Wickramasinghe", rating: 5, review: "Makeup brushes are super soft and blend everything beautifully. Worth every rupee!", type: "good" },
...
export default function Reviews() {
    ...
    return (
      <div className="w-full py-1 px-6 md:px-12 bg-white">
        ...
        {/* Review Slideshow */}
        <div className="bg-pink-500 text-white shadow-lg  p-6 w-full sm:w-3/4 md:w-1/2 mx-auto text-center">
