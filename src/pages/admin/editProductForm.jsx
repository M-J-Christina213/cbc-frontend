...
export default function EditProductForm() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      console.error("Error during product update:", err.response ? err.response.data : err.message);
  ...
  return (
    <div className="flex-1 w-full p-8 m-10 bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold text-center text-pink-600 mb-6">Edit Product Form</h2>
      <div className="flex flex-col gap-4 w-1/2 mx-auto">
        <div className="flex flex-col">
          ...
          <input
            ...
            className="p-2 border rounded-md focus:ring-2 focus:ring-pink-600"
            value={productId}
            onChange={(e) => {
        ...
        <button
          type="submit"
          className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-700 text-white font-semibold rounded-lg shadow-lg transition-transform duration-300 ease-in-out transform hover:scale-105"
