...
export default function AdminProductsPage() {
  ...
  return (
      <div className="flex-1 p-8 bg-white rounded-lg shadow-lg m-4">
          <h2 className="text-xl font-bold text-center text-pink-600 mb-6">Welcome to Product Management section</h2> {/* Smaller font size */}
          
          <div className="overflow-x-auto">
              <table className="min-w-full table-auto border-collapse text-sm"> {/* Smaller font size */}
                  <thead>
                  ...
                  <tbody>
                      {products.map((product, index) => (
                          <tr
                              key={index}
                              className={`border-b ${index % 2 === 0 ? "bg-purple-50" : "bg-white"} hover:bg-purple-100`}
                          >
          ...
          <div className="mt-6">
              <Link to="/admin/products/addProduct" className="inline-block px-6 py-3 bg-pink-600 text-white font-semibold rounded-lg shadow-lg hover:bg-gradient-to-r from-purple-500 to-purple-700 transition-all duration-300 ease-in-out transform hover:scale-105 items-center justify-center gap-2">
